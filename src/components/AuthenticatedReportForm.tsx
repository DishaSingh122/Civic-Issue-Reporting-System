...
const AuthenticatedReportForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsUploading(photos.length > 0 || videos.length > 0);
    ...
    try {
      ...
      // Use the tracking code directly
      const displayId = insertedData.tracking_code.toUpperCase();
      setReportId(displayId);

      toast({
        title: "Report Submitted Successfully!",
        description: `Your issue has been reported and will be reviewed by our staff. Tracking ID: #${displayId}`,
      });
...
export default AuthenticatedReportForm;